"""
SQL manipulation module from CS50 a Python library
https://github.com/cs50/python-cs50/blob/464f237e32bc2f87affd34722a498054dc0d57f6/src/cs50/sql.py

This material is distribured by `Harvard © 2023 edX LLC`. It was copied during the execution of the
Course, and have been modified due to my undersantding and integrated to the previous Data Structure
of `Programing Studies`.
